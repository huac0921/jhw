...
if($c == 'login')
{
	...
	{
		require(FMOONS_TEMP.'/default/member/login.php');
		exit();
	}
}
...
if($c == 'default')
{
	require(FMOONS_TEMP.'/default/member/default.php');
	exit();
}

else if($c == 'avatar')
{		
	require(FMOONS_TEMP.'/default/member/avatar.php');
	exit();
}

else if($c == 'edit')
{		
	require(FMOONS_TEMP.'/default/member/edit.php');
	exit();
}

else if($c == 'comment')
{	
	require(FMOONS_TEMP.'/default/member/comment.php');
	exit();
}

else if($c == 'favorite')
{
	require(FMOONS_TEMP.'/default/member/favorite.php');
	exit();
}

else if($c == 'friend')
{
	require(FMOONS_TEMP.'/default/member/friend.php');
	exit();
}
else if($c == 'order')
{
	require(FMOONS_TEMP.'/default/member/order.php');
	exit();
}

else if($c == 'ordershow')
{
	require(FMOONS_TEMP.'/default/member/ordershow.php');
	exit();
}

else if($c == 'msg')
{
	require(FMOONS_TEMP.'/default/member/msg.php');
	exit();
}

else if($c == 'reg')
{
	require(FMOONS_TEMP.'/default/member/reg.php');
	exit();
}

else if($c == 'findpwd')
{
	require(FMOONS_TEMP.'/default/member/findpwd.php');
	exit();
}
...
else if($c == 'findpwd2')
{
	...
	{
		require(FMOONS_TEMP.'/default/member/findpwd2.php');
		exit();
	}
}
...
else if($c == 'findpwd3')
{
	...
	{
		require(FMOONS_TEMP.'/default/member/findpwd3.php');
		exit();
	}
}
