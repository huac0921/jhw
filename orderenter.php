...
<div class="subBody" style="width:950px; background:#FFFFFF">
	...
	<form name="form" id="form" method="post" action="">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shoppingcart">
			...
			<tr>
				...
				?></td>
				<td><?php echo $goods[1]; ?>&nbsp;&nbsp;箱</td>
				<td><?php echo $r['salesprice'] * $goods[1]; ?>&nbsp;&nbsp;元</td>
			</tr>
			<?php
			}
			?>
            ...
            <tr>
                <td>数量总计：<?php echo $totalnumber?></td>
            </tr>
		</table>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="shoppingcart">
			<tr>
			...
			<tr>
				<td height="60" colspan="2" align="right" valign="bottom">
					<strong class="total">总计：</strong><span class="totalprice"><?php echo $orderinfo['totalprice'] + $orderinfo['cost']*$totalnumber; ?>元</span>
                    （包含运费：<?php echo $orderinfo['cost']*$totalnumber; ?>元）<a href="javascript:history.go(-1);" class="next">上一步</a><a href="javascript:;" onclick="form.submit();" class="next">提　交</a></td>
			</tr>
