		...
		<ul class="msglist">
			...
			<li>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="orderlist">
					...
					?>
					<tr>
						<td height="35" colspan="5" align="right" valign="bottom"><strong class="total">订单编号：</strong><?php echo $row['ordernum']; ?><strong class="total">订单时间：</strong><?php echo GetDateTime($row['posttime']); ?><strong class="total">订单状态：</strong><span class="blue">
							<?php
