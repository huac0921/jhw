...
<form name="form" id="form" method="post" action="goods_save.php" onsubmit="return cfm_goods();">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
        ...
        <tr>
            <td height="35" align="right">商品规格：</td>
            <td><input name="unit" type="text" class="input_short" id="unit" /></td>
        </tr>
		<tr>
		...
		<tr>
			<td height="35" align="right">商品起售量：</td>
			<td><input name="saleminnum" type="text" id="saleminnum" class="input_short" value="<?php echo $row['saleminnum'];?>" /></td>
		</tr>
		<tr class="nb">
