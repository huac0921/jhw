...
if($dopost == 'backup')
{
	...
	$tmsg = '<div class="loading" style="width:140px;margin:0;"><img src="templates/images/loading.gif">正在执行备份操作...</div><br />';
...
if($dopost == 'reset')
{
	...
	$tmsg = '<div class="loading" style="width:160px;margin:0;"><img src="templates/images/loading.gif">正在准备还原其它数据...</div><br />';
	$backup_dir .= $dirname.'/';
	$structfile = '';
