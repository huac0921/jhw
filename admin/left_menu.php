...
<body>
<div class="quickbtn"> <span class="quickbtn_left"><a href="infolist_add.php" target="main">添列表</a></span> <span class="quickbtn_right"><a href="goods_add.php" target="main">添商品</a></span> </div>
	...
	<div class="viewport">
		<div class="overview"> 
			...
			<div class="menubox">
				...
				<div id="leftmenu01"> <a href="admin.php" target="main">管理员管理</a> <a href="site.php" target="main">站点配置管理</a> <a href="web_config.php" target="main">网站信息配置</a> <a href="upload_filemgr_sql.php" target="main">上传文件管理</a><a href="database_backup.php" target="main">数据库管理</a> 
				<a href="admingroup.php" target="main" title="管理组管理" class="admingroup"></a> </div>
			</div>
			<div class="hr_5"></div>
			<div class="menubox">
			...
			<div class="menubox">
				...
				<div id="leftmenu06" style="display:none;"> <a href="upload_file.php" target="main">上传新文件</a>
                    <a href="import_excel.php" target="main">产品批量导入</a>
					<div class="hr_1"> </div>
...
<div class="hr_5"></div>
<div class="copyright"> © 2015 JIAOHUOWANG.com<br />
