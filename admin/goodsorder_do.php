...
?>
<div class="gray_header"> <span class="title">查看订单</span> <span class="reload"><a href="javascript:location.reload();">刷新</a></span> </div>
<form name="form" id="form" method="post" action="goodsorder_save.php" onsubmit="return cfm_goodsorder();">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form_table">
        ...
        <tr>
            <td height="420" align="right">商品列表：</td>
        ...
        <tr id="act-pnt" style="position:absolute; left:50px;"><a href="javascript:;" onclick="window.print();">打印</a></tr>
    </table>
