...
<form name="form" id="form" method="post" action="goodsorder_save.php">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mgr_table">
		...
		<tr align="center" class="mgr_tr">
			...
			?></td>
			<td class="action"><span>[<a href="goodsorder_update.php?id=<?php echo $row['id']; ?>">修改</a>]</span><span>[<a href="goodsorder_do.php?id=<?php echo $row['id']; ?>">查看</a>]</span><span>[<a href="goodsorder_save.php?action=del2&id=<?php echo $row['id']; ?>" onclick="return ConfDel(0)">删除</a>]</span></td>
