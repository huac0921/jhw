...
<body>
<div class="quickbtn"> <span class="quickbtn_left"><a href="goods_add.php" target="main">添商品</a></span> <span class="quickbtn_right"><a href="infoimg_add.php" target="main">添图片</a></span> </div>
...
<div id="scrollmenu">
	...
	<div class="viewport">
		<div class="overview">
			...
			//获取管理员模块权限
			$dosql->Execute("SELECT `model` FROM `#@__adminprivacy` WHERE `groupid`=".$_SESSION['adminlevel']." AND `model`<>'category'");
			$modelPriv = array();
			...
			else
			{
				...
				$leftMenu05_Str = '';
				$leftMenu05_Arr = array('nav'=>'<a href="nav.php" target="main">导航菜单设置</a>',
									'editfile'=>'<a href="editfile.php" target="main">默认模板管理</a>');
				
				$leftMenu06_Str = '';
				$leftMenu06_Arr = array('upload_file'=>'<a href="upload_file.php" target="main">上传新文件</a>',
				...
				if($leftMenu01_Str != '')
				{
					echo '<div class="menubox"><div class="title ton" id="t1" onclick="DisplayMenu(\'leftmenu01\');" title="点击切换显示或隐藏"> 网站系统管理 </div><div id="leftmenu01">';
					echo $leftMenu01_Str;
				...
				if($leftMenu03_Str != '')
				{
					...
					{
						echo '<div class="menubox"><div class="title ton" id="t1" onclick="DisplayMenu(\'leftmenu03\');" title="点击切换显示或隐藏"> 模块扩展管理 </div><div id="leftmenu03">';
					}
...
<div class="copyright">
    © 2015 JIAOHUOWANG.com<br />All Rights Reserved.
</div>
<?php
