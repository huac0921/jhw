...
if($action == 'add')
{
	...
	$sql = "INSERT INTO `$tbname` (groupname, description, checkinfo) VALUES ('$groupname', '$description', '$checkinfo')";
...
else if($action == 'update')
{
	...
	$sql = "UPDATE `$tbname` SET groupname='$groupname', description='$description', checkinfo='$checkinfo' WHERE id=$id";
