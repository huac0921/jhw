...
.loadnews{background:url(templates/images/list_load2.gif) no-repeat 0 center;padding-left:21px;color:#307cd5;}
...
<script type="text/javascript" src="http://phpmywind.com/clientnews/clientnews.js"></script>
</body>
</html>